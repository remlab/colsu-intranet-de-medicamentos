...
import * as strings from 'NoticiasDestacadoWebPartStrings';
import NoticiasDestacado from './components/NoticiasDestacado';
import { INoticiasDestacadoProps } from './components/INoticiasDestacadoProps';
...
export default class NoticiasDestacadoWebPart extends BaseClientSideWebPart<INoticiasDestacadoWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<INoticiasDestacadoProps> = React.createElement(
      NoticiasDestacado,
      {
