...
import * as strings from 'NodosDomicilioWebPartStrings';
import NodosDomicilio from './components/NodosDomicilio';
import { INodosDomicilioProps } from './components/INodosDomicilioProps';
...
export default class NodosDomicilioWebPart extends BaseClientSideWebPart<INodosDomicilioWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<INodosDomicilioProps> = React.createElement(
      NodosDomicilio,
      {
