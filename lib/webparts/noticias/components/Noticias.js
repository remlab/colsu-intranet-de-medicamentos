...
var Noticia = /** @class */ (function (_super) {
    __extends(Noticia, _super);
    function Noticia(props) {
        var _this = _super.call(this, props) || this;
        _this.state = { file: null };
        return _this;
    }
    Noticia.prototype.componentDidMount = function () {
    ...
    Noticia.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames(["swiper-slide", styles.news]) },
            ...
            React.createElement("div", { className: styles.news_content },
                React.createElement("h4", { className: styles.news__title }, Title),
                Description && React.createElement("p", { className: styles.news__description }, Description),
                this.state.file && React.createElement("a", { href: OData__OriginalSourceUrl || this.state.file.File.ServerRelativeUrl, title: this.state.file.File.Name }, "Ver detalle"))));
    };
    return Noticia;
}(React.Component));
var Noticias = /** @class */ (function (_super) {
    ...
    Noticias.prototype.componentDidMount = function () {
        this.update();
    };
    Noticias.prototype.render = function () {
        var _this = this;
        ...
        return (React.createElement("div", { className: styles.noticias },
            React.createElement("div", { className: styles.container },
                React.createElement("div", { className: styles.row },
                    React.createElement("div", { className: styles.column['ms-lgPush1'] },
                        React.createElement("div", { className: styles.section_news },
                            React.createElement("div", { className: styles.section_news__newsCarousel },
                                React.createElement("div", { className: styles.titleSection },
                                ...
                                React.createElement(IntranetMedicamentosCRUDList, { listId: list, spHttpClient: context.spHttpClient, siteUrl: context.pageContext.web.absoluteUrl }, function (listName) { return (React.createElement(IntranetMedicamentosPageList, { propertyPane: _this.props.context.propertyPane, inDesignMode: _this.props.inDesignMode, listName: listName, filterTag: filterTag }, function (_a) {
                                    ...
                                    return (React.createElement(Swiper, __assign({}, {
                                        ...
                                        var data = item;
                                        return (React.createElement(Noticia, { key: index, data: data, listName: listName }));
                                    })));
                                })); }))))))));
    };
    return Noticias;
