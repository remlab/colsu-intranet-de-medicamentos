...
var Nodo = /** @class */ (function (_super) {
    ...
    Nodo.prototype.componentDidMount = function () {
    ...
    Nodo.prototype.render = function () {
        if (!this.state.file)
            return React.createElement("p", null, "Loading!");
        return (React.createElement("a", { href: this.state.file.File.ServerRelativeUrl, title: this.state.file.File.Name }, this.props.data.BannerImageUrl && this.props.data.BannerImageUrl.Url ?
...
var NodosDomicilio = /** @class */ (function (_super) {
    __extends(NodosDomicilio, _super);
    function NodosDomicilio() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NodosDomicilio.prototype.render = function () {
        var _this = this;
        ...
        return (React.createElement("div", { className: styles.section_deliveryNodes },
            React.createElement("div", { className: styles.section_deliveryNodes__header },
            ...
            React.createElement(IntranetMedicamentosCRUDList, { listId: list, spHttpClient: context.spHttpClient, siteUrl: context.pageContext.web.absoluteUrl }, function (listName) { return (React.createElement(IntranetMedicamentosPageList, { propertyPane: _this.props.context.propertyPane, inDesignMode: _this.props.inDesignMode, listName: listName, filterTag: filterTag }, function (_a) {
                ...
                return (React.createElement("div", { className: styles.section_deliveryNodes__content }, items.map(function (item, index) {
                    var data = item;
                    return (React.createElement(Nodo, { data: data, listName: listName }));
                })));
            })); })));
    };
    return NodosDomicilio;
}(React.Component));
export default NodosDomicilio;
//# sourceMappingURL=NodosDomicilio.js.map