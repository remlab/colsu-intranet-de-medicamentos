...
var ConveniosWebPart = /** @class */ (function (_super) {
    __extends(ConveniosWebPart, _super);
    function ConveniosWebPart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ConveniosWebPart.prototype.onInit = function () {
        var _this = this;
    ...
    ConveniosWebPart.prototype.render = function () {
        var element = React.createElement(Convenios, __assign({ context: this.context, inDesignMode: this.displayMode === DisplayMode.Edit }, this.properties));
        ReactDom.render(element, this.domElement);
    };
    ConveniosWebPart.prototype.onDispose = function () {
        ReactDom.unmountComponentAtNode(this.domElement);
    };
    Object.defineProperty(ConveniosWebPart.prototype, "dataVersion", {
        get: function () {
    ...
    ConveniosWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
    ...
    return ConveniosWebPart;
}(BaseClientSideWebPart));
export default ConveniosWebPart;
//# sourceMappingURL=ConveniosWebPart.js.map